...
|---:|---|---|---|---|
| 01 | [地図を表示](公開URL) | [Notebook](01_Syria_White_basemap.ipynb) | CARTO Light — No Labels | 主題レイヤーを重ねるための白背景 |
| 02 | [地図を表示](公開URL) | [Notebook](02_Syria_Dark_basemap.ipynb) | CARTO Dark — No Labels | 明るいレイヤーデータを載せるための黒背景 |
| 03 | [地図を表示](公開URL) | [Notebook](03_Syria_Satellite_basemap.ipynb) | Esri World Imagery | 地表の状況を確認するための衛星画像 |
| 04 | [地図を表示](公開URL) | [Notebook](04_Syria_Physical_basemap.ipynb) | Esri World Terrain | 地形を確認するための地形図 |
